...
| `visResultater()` | «📈 Siste kamper» på ranking-banneret: den søkte spillerens kamper, nyeste turnering først, 5 om gangen (`RES_SIDE`). Bruker samme kall som H2H uten motstander. Motstandernavn åpner H2H |
